...
```javascript
maxabs = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-maxabs@v0.3.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-maxabs/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/math-base-special-maxabs/actions/workflows/test.yml?query=branch:v0.3.1
